...
object BlocksRenderer {
    ...
    fun drawBlocks(
        ...
        //because the image rotation is 90/270 we had to rotate the height and width
        //we also had to multiply them by the scale to match the size of the view to the taken image
